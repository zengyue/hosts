...
_R={//render
	...
	editBox:function(){
        var H=''
            ...
            +'<p><input id="submitEdit" type="button" value="提交"/>'
            +'<input id="closeEdit" type="button" value="关闭"/></p>'
            +'</div>'
            +'';
        return H;
	...
	copyRight:function(){
        var H='<div id="copyRight">'
            ...
            +'<p>更新时间:'+_C.update+' <span style="cursor:pointer;color:green;" onclick="_A.update()">检查更新</span></p>'
            +'</div>';
        return H;
